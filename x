	...
	toggleButton.Image = "rbxassetid://72765693556247"
	...
	local Tabs = {
		...
		SeaEvent = Window:AddTab({
			Title = "Морские ивенты"
		}),
		Prehistoric = Window:AddTab({
			Title = "Вулканический остров"
		}),
		Drago = Window:AddTab({
			Title = "Драго Додзе Остров"
		})
	}
	...
	if World3 then
		...
		local TeleportToggle = Tabs.Main:AddToggle("tpSubmarineWorker", {
			Title = "Авто фарм уровня (Сабмарина)",
			Description = "",
			Default = false,
	...
	Tabs.Main:AddSection("Разное / Квест")
	local ClosetMons = Tabs.Main:AddToggle("ClosetMons", {
		Title = "Авто фарм окружностей",
		Description = "",
		Default = false
	})
	...
	Tabs.Main:AddSection("Разное / Мастерство")
	local posMastery = {
		"Cake",
		"Bone"
	}
	local Mastery_Config = Tabs.Main:AddDropdown("Mastery_Config", {
		Title = "Выбрать остров",
		Values = posMastery,
		Multi = false,
		Default = 1
	})
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Авто разблокировка рейда Феникса",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Main:AddSection("Хаки / Цвета ауры")
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Автотелепортация кузена бариста",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Квест радужной ауры (Быстро)",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Main:AddSection("Инстинкт / Кен")
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Авто фарм кена",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Main:AddSection("Апгрейд расы до В3")
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Авто Mink V3",
		Description = "",
		Default = false
	...
	Tabs.Main:AddSection("Дарк даггер + Валкирия")
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Авто Валькирия",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	local Q = Tabs.Main:AddToggle("Q", {
		Title = "Авто разблокированная головоломка",
		Description = "",
		Default = false
	})
	Q:OnChanged(function(Value)
	...
	Tabs.Settings:AddSection("Настройка / Конфигурация")
	local _Weapon = {
		"Melee",
		"Sword",
		"Blox Fruit",
	...
	local BusuAura = Tabs.Settings:AddToggle("BusuAura", {
		Title = "Автоматическое включение хаки",
		Description = "",
		Default = true
	})
	...
	local RaceV3Aura = Tabs.Settings:AddToggle("RaceV3Aura", {
		Title = "Автоматическое включение Race V3",
		Description = "",
		Default = false
	})
	...
	local RaceV4Aura = Tabs.Settings:AddToggle("RaceV4Aura", {
		Title = "Автоматическое включение Race V4",
		Description = "",
		Default = false
	})
	...
	local RandomAround = Tabs.Settings:AddToggle("RandomAround", {
		Title = "Включение положения вращения",
		Description = "",
		Default = false
	})
	...
	local Byp = Tabs.Settings:AddToggle("Byp", {
		Title = "Включить обход телепорта",
		Description = "",
		Default = false
	})
	...
	local DisblesVFX = Tabs.Settings:AddToggle("DisblesVFX", {
		Title = "Удалить эффекты смерти и возрождения",
		Description = "",
		Default = false
	})
	DisblesVFX:OnChanged(function(Value)
	...
	Tabs.Settings:AddSection("Прокачка статистики")
...
spawn(function()
	...
	Tabs.Travel:AddSection("Телепортироватся в миры")
	Tabs.Travel:AddButton({
		Title = "Телепорт в первое море",
		Description = "",
		Callback = function()
	...
	Tabs.Travel:AddButton({
		Title = "Телепорт в третье море",
		Description = "",
		Callback = function()
			replicated.Remotes.CommF_:InvokeServer("TravelZou")
		end
	})
	Tabs.Travel:AddSection("Телепортироватся в острова")
	Location = {}
	for i, v in pairs(workspace["_WorldOrigin"].Locations:GetChildren()) do
		table.insert(Location , v.Name)
	end
	Travelllll = Tabs.Travel:AddDropdown("Travelllll", {
		Title = "Выберите остров",
		Values = Location,
		Multi = false,
		Default = 1
	})
	...
	GoIsland = Tabs.Travel:AddToggle("GoIsland", {
		Title = "Автоматически добратся до острова",
		Description = "",
		Default = false
	})
	...
	Tabs.Travel:AddSection("Телепортироватся в порталы")
	if World1 then
		Location_Portal = {
			"Sky",
			"UnderWater"
	...
	Tabs.Travel:AddSection("Телепортироватся к НПС")
	for _, v in pairs(replicated.NPCs:GetChildren()) do
	...
	GoNPCs = Tabs.Travel:AddToggle("GoNPCs", {
		Title = "Автоматически добратся к НПС",
		Description = "",
		Default = false
	})
	...
	Tabs.Server:AddButton({
		Title = "Сервер почти без человек",
		Description = "",
		Callback = function()
	...
	Tabs.Misc:AddSection("Интерфейс игрока / Другое")

	Tabs.Misc:AddButton({
		Title = "Эксперт по открытым пробуждениям",
		Description = "",
		Callback = function()
	...
	DisbleChat = Tabs.Misc:AddToggle("DisbleChat", {
		Title = "Отключить графический интерфейс чата",
		Description = "",
		Default = false
	})
	...
	DisbleLeaderB = Tabs.Misc:AddToggle("DisbleLeaderB", {
		Title = "Отключить интерфейс таблицы лидеров",
		Description = "",
		Default = false
	})
	...
	Tabs.Misc:AddButton({
		Title = "Установить пиратскую команду",
		Description = "",
		Callback = function()
			Pirates()
		end
	...
	Tabs.Misc:AddButton({
		Title = "Установить морскую команду",
		Description = "",
		Callback = function()
			Marines()
		end
	...
	UnPortal = Tabs.Misc:AddToggle("UnPortal", {
		Title = "Разблокировать все порталы",
	...
	Tabs.Misc:AddSection("Графика / Статистика Хаки")
	...
	Tabs.Misc:AddButton({
		Title = "Включить низкую загрузку ЦП",
		Description = "",
		Callback = function()
			LowCpu()
		end
	...
	Tabs.Misc:AddButton({
		Title = "Включить увеличение Лодки",
		Description = "",
		Callback = function()
	...
	Tabs.Misc:AddSection("Настроить - Бог")
	Tabs.Misc:AddButton({
		Title = "Фрукты дождя (Клиент)",
		Description = "",
		Callback = function()
